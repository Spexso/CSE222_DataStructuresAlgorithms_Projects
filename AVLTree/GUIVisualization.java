...
/**
 * GUIVisualization class for visualizing data in a graphical user interface.
 */
public class GUIVisualization extends JFrame {
     ...
     */
    public GUIVisualization(String title, String plotType, List<Integer> dataPointsX, List<Long> dataPointsY) {
        this.plotType = plotType; // Set the plot type
        this.dataPointsX = dataPointsX; // Initialize x-axis data points list with provided data
        this.dataPointsY = dataPointsY; // Initialize y-axis data points list with provided data

        setTitle(title); // Set the title of the window
        setSize(1920, 1080); // Set the size of the window
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // Set the default close operation
        setLocationRelativeTo(null); // Center the window on the screen
    }

    /**
     * Paint method to draw the graph.
    ...
    /**
     * Method to draw the graph on the window.
     * @param g Graphics object for drawing.
     */
    ...
    /**
     * Get the maximum y value from the data points.
    ...
    /**
     * Main method to run the GUI visualization.
